...
{
  static final int OVERLAY_PERMISSION_REQUEST_CODE = 1001;
  ...
  public void launch_overlay_settings(View v)
  {
  ...
  {
    TextView status = (TextView)findViewById(R.id.launcher_overlay_status);
    Button btn = (Button)findViewById(R.id.launcher_btn_overlay);
    if (Settings.canDrawOverlays(this))
    {
      status.setText(R.string.launcher_overlay_granted);
      btn.setVisibility(View.GONE);
    }
    else
    {
      status.setText(R.string.launcher_overlay_explanation);
