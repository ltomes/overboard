...
import com.overboard.keyboard.prefs.CustomExtraKeysPreference;
import com.overboard.keyboard.prefs.ExtraKeysPreference;
...
public final class Config
{
  ...
  // Overlay features
  public boolean labelOutline;
  public boolean labelShadow;
  public boolean topGradientEnabled;
  public boolean idleFadeEnabled;
  public long idleFadeTimeout; // milliseconds
  public boolean collapseButtonEnabled;
  ...
  public void refresh(Resources res, Boolean foldableUnfolded, Dictionaries dicts)
  {
    ...
    labelShadow = _prefs.getBoolean("label_shadow", false);
    topGradientEnabled = _prefs.getBoolean("top_gradient", false);
